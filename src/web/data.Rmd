...
Doc2Vec, a method we selected, utilizes the raw abstract text. It takes items such as common words (i.e. the, and, it) and non-alphabetic characters into account to give documents as a whole meaning. Our other vectorization method, TF-IDF, requires text processing to be effective.  
